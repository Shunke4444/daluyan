...
const dict = {
  en: {
    ...
    triageTitle: "Messages", triageSub: "Requests and urgent replies that still need an operator. Dispatch a tanod, then mark handled.",
  ...
  fil: {
    ...
    triageTitle: "Messages", triageSub: "Mga request at agarang sagot na kailangan pa ng operator. Magpadala ng tanod, tapos markahan.",
